// compile with
// cc -c -I`ocamlc -where` mem_map32_stubs.c
...
value caml_mem_map32_mmap(value addr, value len)
{
  CAMLparam2 (addr, len);
...
value caml_mem_map32_read(value mptr, value offset)
{
...
value caml_mem_map32_write(value mptr, value offset, value data)
{
